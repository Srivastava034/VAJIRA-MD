...
global.owner = process.env.OWNER_NUMBER  || '' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=TRM1ibbA#afwtp-yXlowEw4DlfAPiGKWVgBl8uprm6J8L1i9z68A' ,
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? 'null' : process.env.DELETEMSGSENDTO    
};
